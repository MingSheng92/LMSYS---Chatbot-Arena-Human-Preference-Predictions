...
def get_now_time_fullstring():
    # return with full timeformat，etc "2023-06-05 16:35:00"
...
def init_logger(log_file):
    # initialize our log functionalitu
...
def get_timediff(time1,time2):
    # calculate the difference of two provided time in minutes and seconds
